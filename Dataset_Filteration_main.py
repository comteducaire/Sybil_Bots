...
with open('filtered_results.csv', 'a+', newline='',  encoding='utf-8') as csvfile_clean:
                ...
                try :
                    ...
                    if posting_rate != 'Posting_Rate' and bot_type == 'Political_Bot' and float(posting_rate) > 2.0:
                        writer.writerow([id_of_tweet, screen_name, length_username, followers_to_friends_ratio,
                                     posting_rate, location, url, creation_date, followers_num, friends_num,
                                     statuses_count, likes, likes_rate, is_verified, has_extended_profile,
